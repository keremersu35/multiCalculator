...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.tab2_text_1, R.string.tab2_text_2};
    ...
    public Fragment getItem(int position) {
        ...
        if(position == 0)
            return binaryToHexadecimalFragment.newInstance();
        else
            return hexadecimalToBinaryFragment.newInstance();
    }
